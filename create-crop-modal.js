...
const componentContent = `import React, { useState, useRef } from 'react';
import {
  Modal,
  View,
  Text,
...
fs.writeFileSync(path.join(dir, 'ImageCropModal.tsx'), componentContent, 'utf8');
console.log('ImageCropModal.tsx criado em src/components/common/');
console.log('Tamanho:', componentContent.length, 'bytes');
