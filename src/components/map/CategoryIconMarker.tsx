...
interface CategoryIconMarkerProps {
  business: Business;
  onPress?: () => void;
}
...
export const CategoryIconMarker: React.FC<CategoryIconMarkerProps> = memo(({ business, onPress }) => {
  ...
  return (
    <Marker
      key={`category_marker_${business.id}`}
      coordinate={{
...
CategoryIconMarker.displayName = 'CategoryIconMarker';
