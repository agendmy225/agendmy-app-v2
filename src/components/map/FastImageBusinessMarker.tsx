...
export const FastImageBusinessMarker: React.FC<BusinessMarkerProps> = memo(({ business, onPress }) => {
  ...
  const handleImageError = () => {
    console.error(`ݒ Erro FastImage para ${business.name}`);
    setImageError(true);
    setImageLoaded(false);
  };
          ...
          {business.logo && !imageError ? (
            <>
              <FastImage
                source={{ 
                  uri: business.logo,
                  cache: FastImage.cacheControl.immutable, // Cache agressivo
...
FastImageBusinessMarker.displayName = 'FastImageBusinessMarker';
